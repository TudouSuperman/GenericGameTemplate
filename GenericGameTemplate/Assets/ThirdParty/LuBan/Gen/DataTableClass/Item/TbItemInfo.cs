...
{
public sealed partial class TbItemInfo :  Bright.Config.BeanBase 
{
    ...
    public static TbItemInfo DeserializeTbItemInfo(ByteBuf _buf)
    {
        return new Item.TbItemInfo(_buf);
    }
    ...
    public Item.TbItemInfo UpgradeToItemId_Ref { get; private set; }
    /// <summary>
    /// 过期时间
    /// </summary>
    ...
    public const int __ID__ = 1305367722;
